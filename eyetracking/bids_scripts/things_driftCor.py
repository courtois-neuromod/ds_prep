        ...
        #try:
            ...
            if is_final:
                ...
                for key in vals2plot:
                    ...
                    ax_dict[refs[0]].scatter(clean_times, clean_dist_x, c='xkcd:light blue', s=20, alpha=0.2)
                    ...
                    ax_dict[refs[1]].scatter(clean_times, clean_dist_y, c='xkcd:light blue', s=20, alpha=0.2)
                    ...
                    ax_dict[refs[2]].scatter(clean_times, clean_distInDeg, c='xkcd:light blue', s=20, alpha=0.2)
