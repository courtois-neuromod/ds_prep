...
def make_gaze_figures(good_runs, calib_gaze_allruns, run_gaze_allruns, out_name=None, driftcorrect=False):
    '''
    E.g.,
    good_runs = ["1", "2", "6"]
    ...
    make_composite_figure(good_runs, r_x, r_times, out_name=out_name + '_Xposition_run.png', driftcorrect=driftcorrect)
    make_composite_figure(good_runs, r_y, r_times, out_name=out_name + '_Yposition_run.png', driftcorrect=driftcorrect)
...
if __name__ == "__main__":
    ...
    try:
        ...
        make_gaze_figures(good_runs, calib_gaze_allruns, run_gaze_allruns, cfg['out_dir'] + '/qc/Gaze_online2D', driftcorrect=args.driftcor)
