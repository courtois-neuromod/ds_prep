...
rec_exclude = ['ORIGINAL', 'PRIMARY', 'M', 'MB', 'ND', 'MOSAIC','NONE', 'DIFFUSION', 'UNI']
...
#            seq['acq'] = slice_orient.value.lower()
        ...
        seq['label'] = 'T2w'
    elif ('*tfl3d1_16' in s.sequence_name) and \
         (s.dim4 == 1) and \
         ('mp2rage' in s.protocol_name) and \
         not ('memp2rage' in s.protocol_name):
        seq['label'] = 'MP2RAGE'
